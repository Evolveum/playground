...
//        aa2.add(new AceEditor("editor", new Model<String>("<foo>bar</foo>")));
        ...
        Accordion a3 = new Accordion("accordions3");
        ...
        Accordion a4 = new Accordion("accordions4");
