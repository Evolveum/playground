...
public class PropertyValueWrapper<T> implements Serializable {
    ...
    public PropertyValueWrapper(PropertyWrapper property, PropertyValue<T> value) {
        this(property, value, ValueStatus.NOT_CHANGED);
    }

    public PropertyValueWrapper(PropertyWrapper property, PropertyValue<T> value, ValueStatus status) {
