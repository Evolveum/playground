package eu.evolveum.midpoint.web.admin.user;
...
import eu.evolveum.midpoint.web.admin.PageAdmin;
import eu.evolveum.midpoint.web.component.autoform.*;
import eu.evolveum.midpoint.web.component.util.LoadableModel;
    ...
    public PageUser() {
        IModel<FormObject> model = new LoadableModel<FormObject>(false) {
            ...
            protected FormObject load() {
                ...
                try {
                    URL url = PageUser.class.getClassLoader().getResource("eu/test/resource.xml");
