...
public abstract class EncryptedType implements Serializable {
    ...
    public final static QName COMPLEX_TYPE = new QName(SchemaConstants.NS_XML_ENC, "EncryptedType");
    public final static QName F_ENCRYPTION_METHOD = new QName(SchemaConstants.NS_XML_ENC, "encryptionMethod");
    public final static QName F_KEY_INFO = new QName(SchemaConstants.NS_XML_ENC, "keyInfo");
    public final static QName F_CIPHER_DATA = new QName(SchemaConstants.NS_XML_ENC, "cipherData");
    public final static QName F_ENCRYPTION_PROPERTIES = new QName(SchemaConstants.NS_XML_ENC, "encryptionProperties");
    public final static QName F_ID = new QName(SchemaConstants.NS_XML_ENC, "id");
    public final static QName F_TYPE = new QName(SchemaConstants.NS_XML_ENC, "type");
    public final static QName F_MIME_TYPE = new QName(SchemaConstants.NS_XML_ENC, "mimeType");
    public final static QName F_ENCODING = new QName(SchemaConstants.NS_XML_ENC, "encoding");
