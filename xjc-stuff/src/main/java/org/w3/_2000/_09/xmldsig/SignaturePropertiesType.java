...
public class SignaturePropertiesType implements Serializable {
    ...
    protected String id;
    public final static QName COMPLEX_TYPE = new QName(SchemaConstants.NS_XML_DSIG, "SignaturePropertiesType");
    public final static QName F_SIGNATURE_PROPERTY = new QName(SchemaConstants.NS_XML_DSIG, "signatureProperty");
