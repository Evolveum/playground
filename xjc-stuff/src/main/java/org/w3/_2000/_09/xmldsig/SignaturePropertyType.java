...
public class SignaturePropertyType implements Serializable {
    ...
    protected String id;
    public final static QName COMPLEX_TYPE = new QName(SchemaConstants.NS_XML_DSIG, "SignaturePropertyType");
    public final static QName F_CONTENT = new QName(SchemaConstants.NS_XML_DSIG, "content");
    public final static QName F_TARGET = new QName(SchemaConstants.NS_XML_DSIG, "target");
