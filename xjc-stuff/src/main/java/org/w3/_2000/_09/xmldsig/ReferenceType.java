...
public class ReferenceType implements Serializable {
    ...
    public final static QName COMPLEX_TYPE = new QName(SchemaConstants.NS_XML_DSIG, "ReferenceType");
    public final static QName F_TRANSFORMS = new QName(SchemaConstants.NS_XML_DSIG, "transforms");
    public final static QName F_DIGEST_METHOD = new QName(SchemaConstants.NS_XML_DSIG, "digestMethod");
    public final static QName F_DIGEST_VALUE = new QName(SchemaConstants.NS_XML_DSIG, "digestValue");
