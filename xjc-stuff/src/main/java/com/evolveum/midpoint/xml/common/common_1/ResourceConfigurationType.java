    ...
    implements Serializable, Equals, HashCode
{
    ...
    public final static QName ELEMENT_TYPE = new QName("http://midpoint.evolveum.com/xml/ns/public/common/common-1.xsd", "ResourceConfigurationType");
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ResourceConfigurationType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ResourceConfigurationType that = ((ResourceConfigurationType) object);
        {
            List<Object> lhsAny;
