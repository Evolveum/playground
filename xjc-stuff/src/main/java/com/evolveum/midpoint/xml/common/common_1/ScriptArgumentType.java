    ...
    implements Serializable, Equals, HashCode
{
    ...
    public final static QName ELEMENT_TYPE = new QName("http://midpoint.evolveum.com/xml/ns/public/common/common-1.xsd", "ScriptArgumentType");
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ScriptArgumentType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final ScriptArgumentType that = ((ScriptArgumentType) object);
        {
            String lhsName;
