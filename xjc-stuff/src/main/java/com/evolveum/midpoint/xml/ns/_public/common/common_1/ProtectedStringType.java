...
public class ProtectedStringType implements Serializable {
    ...
    public final static QName COMPLEX_TYPE = new QName(SchemaConstants.NS_COMMON, "ProtectedStringType");
