...
@XmlType(name = "ProtectedStringType", propOrder = {
    "encryptedData",
    "clearValue"
})
public class ProtectedStringType
    implements Serializable, Equals, HashCode
{
    ...
    public final static QName ELEMENT_TYPE = new QName("http://midpoint.evolveum.com/xml/ns/public/common/common-1.xsd", "ProtectedStringType");
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ProtectedStringType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ProtectedStringType that = ((ProtectedStringType) object);
        {
