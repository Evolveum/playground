    ...
    implements Serializable, Equals, HashCode
{
    ...
    public final static QName ELEMENT_TYPE = new QName("http://midpoint.evolveum.com/xml/ns/public/common/common-1.xsd", "ResourcePasswordDefinitionType");
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ResourcePasswordDefinitionType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ResourcePasswordDefinitionType that = ((ResourcePasswordDefinitionType) object);
        {
