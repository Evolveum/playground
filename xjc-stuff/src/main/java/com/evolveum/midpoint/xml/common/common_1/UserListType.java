    ...
    implements Serializable, Equals, HashCode
{
    ...
    public final static QName ELEMENT_TYPE = new QName("http://midpoint.evolveum.com/xml/ns/public/common/common-1.xsd", "UserListType");
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UserListType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UserListType that = ((UserListType) object);
        {
            List<UserType> lhsUser;
            lhsUser = (((this.user!= null)&&(!this.user.isEmpty()))?this.getUser():null);
            List<UserType> rhsUser;
