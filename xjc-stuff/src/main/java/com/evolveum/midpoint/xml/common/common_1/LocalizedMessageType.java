...
public class LocalizedMessageType
    implements Serializable, Equals, HashCode
{
    ...
    public final static QName ELEMENT_TYPE = new QName("http://midpoint.evolveum.com/xml/ns/public/common/common-1.xsd", "LocalizedMessageType");
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof LocalizedMessageType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final LocalizedMessageType that = ((LocalizedMessageType) object);
        {
            String lhsKey;
            lhsKey = this.getKey();
            String rhsKey;
