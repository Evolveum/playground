 ...
 *       &lt;sequence>
 *         &lt;element name="entry" type="{http://midpoint.evolveum.com/xml/ns/public/common/common-1.xsd}EntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable, Equals, HashCode
{
    ...
    public final static QName ELEMENT_TYPE = new QName("http://midpoint.evolveum.com/xml/ns/public/common/common-1.xsd", "ParamsType");
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final ParamsType that = ((ParamsType) object);
        {
            List<EntryType> lhsEntry;
            lhsEntry = (((this.entry!= null)&&(!this.entry.isEmpty()))?this.getEntry():null);
            List<EntryType> rhsEntry;
