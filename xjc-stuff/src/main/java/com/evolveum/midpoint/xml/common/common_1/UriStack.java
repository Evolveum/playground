    ...
    implements Serializable, Equals, HashCode
{
    ...
    public final static QName ELEMENT_TYPE = new QName("http://midpoint.evolveum.com/xml/ns/public/common/common-1.xsd", "UriStack");
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UriStack)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UriStack that = ((UriStack) object);
        {
            List<String> lhsUri;
