    ...
    implements Serializable, Equals, HashCode
{
    ...
    public final static QName ELEMENT_TYPE = new QName("http://midpoint.evolveum.com/xml/ns/public/common/common-1.xsd", "EntryType");
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof EntryType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final EntryType that = ((EntryType) object);
        {
            Object lhsAny;
            lhsAny = this.getAny();
            Object rhsAny;
